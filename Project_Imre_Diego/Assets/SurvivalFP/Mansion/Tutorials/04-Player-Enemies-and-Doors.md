...
1. Stop Play Mode and open **Assets/SurvivalFP/Mansion/Prefabs/Network Survivor.prefab**.
...
Edit **Assets/SurvivalFP/Prefabs/SurvivalPlayer.prefab** separately if you also want the same change in the offline course. The two player prefabs are separate templates.
...
1. Duplicate **Mansion/Prefabs/Flashlight.prefab**.
...
1. Open **Mansion/Prefabs/Mansion Stalker.prefab**.
...
A downed player retains inventory but cannot normally move or use items. A living teammate carrying a medkit can revive them with E. Full death/disconnect makes required objectives recoverable. Dead/escaped players spectate living players.
...
1. Duplicate **Mansion/Prefabs/Ordinary Door.prefab**.
...
On a pickup > ImpactNoiseEmitter, Minimum Speed ignores gentle contacts, Cooldown prevents rapid repeated impact events, Radius Per Speed scales louder impacts, and Maximum Radius caps them. A very low threshold can make resting objects overly noisy.
