...
Online errors are covered in [multiplayer setup](Tutorials/05-Multiplayer-and-Troubleshooting.md). The offline controller course works without an online lobby.

## The central settings asset

Select **Assets/SurvivalFP/Mansion/MansionSettings.asset**. The existing authored configuration has **60 target rooms, 2 floors, 4-metre floor spacing, 100 objectives, and 8 medkits**. These values have not been changed by the tutorials.
...
Continue with [rooms and stairs](Tutorials/01-Rooms-and-Stairs.md).
