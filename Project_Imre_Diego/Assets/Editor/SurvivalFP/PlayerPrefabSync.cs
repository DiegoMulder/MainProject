...
namespace SurvivalFP.Editor
{
    ...
    {
        public const string PlayerPath = "Assets/SurvivalFP/Prefabs/SurvivalPlayer.prefab";
        ...
        static void MigrateFlashlight(GameObject root)
        {
            ...
            lightSettings.FindProperty("toggleSound").objectReferenceValue = AssetDatabase.LoadAssetAtPath<AudioClip>("Assets/SurvivalFP/Audio/switch_002.ogg");
        ...
        public static void PrepareAndValidate()
        {
            ...
            foreach (var item in UnityEngine.Object.FindObjectsByType<PickupItem>())
                if (item.GetComponent<PlayerFlashlight>()) MigrateFlashlight(item.gameObject);
            const string path = "Assets/SurvivalFP/Pickupables/Flashlight.prefab";
