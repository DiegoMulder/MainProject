...
namespace SurvivalFP.Editor
{
    public static class MansionGeometryValidation
    {
        public static void Run()
        {
            ...
            var stairs=Object.Instantiate(AssetDatabase.LoadAssetAtPath<GameObject>("Assets/SurvivalFP/Mansion/Rooms/Staircase.prefab"),new Vector3(1000,0,1000),Quaternion.identity);
            var player=Object.Instantiate(AssetDatabase.LoadAssetAtPath<GameObject>("Assets/SurvivalFP/Prefabs/SurvivalPlayer.prefab"));player.GetComponent<PlayerController>().enabled=false;
