...
namespace SurvivalFP.Editor
{
    ...
    {
        public const string ScenePath = "Assets/Scenes/CharacterController_Test.unity";
        const string Root = "Assets/SurvivalFP";
        ...
        public static void CreateScene()
        {
            ...
            if (!File.Exists(ScenePath) && !AssetDatabase.CopyAsset("Assets/OutdoorsScene.unity", ScenePath)) throw new InvalidOperationException("Cannot copy the original scene.");
            ...
            var input = InputActionAsset.FromJson(File.ReadAllText("Assets/InputSystem_Actions.inputactions"));
            ...
            File.WriteAllText("Assets/InputSystem_Actions.inputactions", input.ToJson());
            ...
            input = AssetDatabase.LoadAssetAtPath<InputActionAsset>("Assets/InputSystem_Actions.inputactions");
        ...
        static void ConfigureLighting()
        {
            ...
            AssetDatabase.CreateAsset(profile, Root + "/CourseExposure.asset");
        ...
        public static void PolishCourse()
        {
            ...
            var profile = AssetDatabase.LoadAssetAtPath<VolumeProfile>(Root + "/CourseExposure.asset");
