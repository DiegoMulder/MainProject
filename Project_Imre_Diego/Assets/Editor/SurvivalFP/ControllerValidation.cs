...
namespace SurvivalFP.Editor
{
    ...
    public static class ControllerValidation
    {
        ...
        static void RunChecks()
        {
            ...
            var beamTemplate = Resources.Load<GameObject>("FlashlightBeam");
        ...
        static void TestInput()
        {
            ...
            var actions = InputActionAsset.FromJson(File.ReadAllText("Assets/InputSystem_Actions.inputactions"));
            try
            {
