...
namespace SurvivalFP
{
    ...
    public sealed class MansionDevelopmentProbe : MonoBehaviour
    {
        ...
        string directory,mode,cloudCode,lastError=""; int handled; float nextSnapshot; bool drive,cloud,controlled;float immediateDistance;bool requestJump; int driveMode;
