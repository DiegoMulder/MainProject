...
namespace SurvivalFP
{
    ...
    public sealed class WalkieTalkieUse : NetworkBehaviour,IPrimaryUse
    {
        ...
        private void UpdateWalkieMaterial(){if (!walkieRenderer) return; walkieRenderer.sharedMaterial = Powered.Value ? walkieRenderer.sharedMaterial = walkie_On : walkieRenderer.sharedMaterial = walkie_Off;}
    }
}
