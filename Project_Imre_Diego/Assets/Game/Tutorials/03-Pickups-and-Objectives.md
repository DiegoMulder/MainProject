...
1. Open Assets/AI-Tools-DEV/Scenes/CharacterController_Test.unity, outside Play Mode.
2. In Assets/AI-Tools-DEV/Prefabs/Items, duplicate Cube.prefab. Name it Test Relic.
...
1. Open Assets/Game/Prefabs/Items.
...
11. Select Data/NetworkPrefabs.asset, expand its prefab list, and add an entry.
...
1. In Assets/Game/Scripts/Procedural Generation, create a C# script named **OptionalPickupSpawnPoint.cs**. The filename must match the class name.
...
1. Duplicate Prefabs/Items/Medkit.prefab and rename it First Aid Bag.
...
1. Create **Assets/Game/Scripts/Items/BellItemUse.cs** with this code.
